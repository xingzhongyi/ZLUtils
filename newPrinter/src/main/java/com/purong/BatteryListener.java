...
//						Log.e("zhang",
//								"BatteryBroadcastReceiver --> onReceive--> ACTION_BATTERY_CHANGED");
...
//					if (mBatteryStateListener != null) {
//						Log.e("zhang",
//								"BatteryBroadcastReceiver --> onReceive--> ACTION_BATTERY_LOW");
...
//					if (mBatteryStateListener != null) {
//						Log.e("zhang",
//								"BatteryBroadcastReceiver --> onReceive--> ACTION_BATTERY_OKAY");
...
//					break;
				case Intent.ACTION_POWER_CONNECTED:// 接通电源
					if (mBatteryStateListener != null) {
						Log.e("zhang",
								"BatteryBroadcastReceiver --> onReceive--> ACTION_POWER_CONNECTED");
				...
				case Intent.ACTION_POWER_DISCONNECTED:// 拔出电源
					if (mBatteryStateListener != null) {
						Log.e("zhang",
								"BatteryBroadcastReceiver --> onReceive--> ACTION_POWER_DISCONNECTED");
