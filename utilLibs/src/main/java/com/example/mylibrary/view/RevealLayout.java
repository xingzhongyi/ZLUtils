...
public class RevealLayout extends LinearLayout implements Runnable {
    ...
    public RevealLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray=context.obtainStyledAttributes(attrs, R.styleable.RevealLayout);
        reveal_color = typedArray.getColor(R.styleable.RevealLayout_reneal_color, getResources().getColor(R.color.reveal_color));
        typedArray.recycle();
        init();
    }
